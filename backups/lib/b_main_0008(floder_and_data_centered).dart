  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Column(
        ...
        children: [
          // ЗАГОЛОВОК, ДАТА И КНОПКА В ОДНОЙ ЛИНИИ
          Padding(
            ...
            child: Row(
              ...
              children: [
                // ЗАГОЛОВОК СЛЕВА (SelectableText)
                Expanded(
                  child: Container(
                    // Выравниваем заголовок по верху чтобы совпадал с датой и кнопкой
                ...
                Column(
                  ...
                  children: [
                    // Дата
                    Container(
                      margin: EdgeInsets.only(bottom: 4), // Небольшой отступ от кнопки
